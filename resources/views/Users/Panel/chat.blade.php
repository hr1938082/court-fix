...
<body class="aos-all" id="transcroller-body">
  ...
  <menu class=" container menu" id="home" >
    <nav class="undefined main-menu animate__animated animate__bounceInDown " id="menu">
      ...
      <ul id="menu"> 
        <li class="undefined logo menu-logo "><a href="index.html"><img src="{{asset('/src/img/logo.png')}}" alt="#{logoMenu}"/><img class="logo-small court" src="{{asset('/src/img/new-york-state-unified-court-system.svg')}}" alt="#{logoMenu}"/></a></li>
